...
function toggleMode() {
    ...
    document.getElementById('deductionFields').style.display = isBank ? 'flex' : 'none';
...
function addRow() {
    ...
    tr.innerHTML = `
        <td><input type="text" class="form-control form-control-sm invoice-input" placeholder="Invoice No"></td>
    ...
    try {
        ...
        if (data.success && data.data) {
            ...
            data.data.forEach(item => {
                ...
                btnEdit.className = 'btn btn-success btn-sm p-0 px-2';
                ...
                btnPrint.className = 'btn btn-primary btn-sm p-0 px-2';
                ...
                btnDelete.className = 'btn btn-danger btn-sm p-0 px-2';
                ...
                const bankName = item.bank ? item.bank.bankName : '-';
...
async function handleEdit(id) {
    ...
    const tr = document.createElement('tr');
    tr.innerHTML = `
        <td><input type="text" class="form-control form-control-sm invoice-input" value="${item.invoiceNo || ''}" placeholder="Invoice No"></td>
